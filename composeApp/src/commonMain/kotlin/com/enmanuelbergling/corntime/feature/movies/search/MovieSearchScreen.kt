...
import com.enmanuelbergling.corntime.core.ui.components.SwipeToDismissContainer
...
import corntime.composeapp.generated.resources.clear
import corntime.composeapp.generated.resources.clear_string_icon
            ...
            LazyColumn(
                ...
                if (query.isEmpty()) {
                    ...
                    if (searchSuggestions.isNotEmpty()) {
                        items(searchSuggestions, key = { Uuid.random() }) { query ->
                        ...
                        item {
                            Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.End) {
                                TextButton(
                                    ...
                                    Text(text = stringResource( Res.string.clear).uppercase())
                                }
                            }
                        }
                    }
...
fun SearchSuggestionUi(
    ...
    SwipeToDismissContainer(
        onDelete = onDelete,
        modifier = Modifier.height(DimensionTokens.TopAppBarHeight)
