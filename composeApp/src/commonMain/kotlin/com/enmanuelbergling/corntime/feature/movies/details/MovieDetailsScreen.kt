package com.enmanuelbergling.corntime.feature.movies.details
...
import com.enmanuelbergling.corntime.core.ui.components.common.ActorsRowPlaceholder
import com.enmanuelbergling.corntime.core.ui.components.common.WatchListCard
import com.enmanuelbergling.corntime.core.ui.core.dimen
import com.enmanuelbergling.corntime.core.ui.core.isAppending
import com.enmanuelbergling.corntime.core.ui.core.isEmpty
...
import com.enmanuelbergling.corntime.feature.movies.details.model.PersonUiItem
import com.enmanuelbergling.corntime.feature.movies.details.model.toPersonUi
import corntime.composeapp.generated.resources.Res
import corntime.composeapp.generated.resources.add_to_watch_list
import corntime.composeapp.generated.resources.cast
import corntime.composeapp.generated.resources.crew
import corntime.composeapp.generated.resources.details
import corntime.composeapp.generated.resources.list_background_animation
import corntime.composeapp.generated.resources.pop_corn_and_cinema_backdrop
import corntime.composeapp.generated.resources.poster_image
...
private fun AnimatedContentScope.MovieDetailsScreen(
    ...
    Scaffold(
        ...
        val castTitle = stringResource(Res.string.cast)
        val crewTitle = stringResource(Res.string.crew)
    ...
    LazyColumn(
        ...
        stickyHeader {
            Column(
                ...
                Text(
                    text = stringResource(Res.string.watch_lists),
        ...
        items(watchList.itemCount) {
            ...
            list?.let {
                val listContainerColor by animateColorAsState(
                    ...
                    label = stringResource(Res.string.list_background_animation),
                )
