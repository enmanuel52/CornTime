package com.enmanuelbergling.corntime.feature.movies.filter
...
import com.enmanuelbergling.corntime.core.ui.components.common.MovieLandCard
import com.enmanuelbergling.corntime.core.ui.core.dimen
import com.enmanuelbergling.corntime.core.ui.core.isAppending
...
import corntime.composeapp.generated.resources.advanced_movie_filter
import corntime.composeapp.generated.resources.back_icon
import corntime.composeapp.generated.resources.genres
import corntime.composeapp.generated.resources.hide
import corntime.composeapp.generated.resources.order_by
import corntime.composeapp.generated.resources.popularity
import corntime.composeapp.generated.resources.revenue
import corntime.composeapp.generated.resources.to_start_icon
import corntime.composeapp.generated.resources.vote_average
import corntime.composeapp.generated.resources.vote_count
...
private fun MoviesFilterScreen(
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(text = stringResource(Res.string.advanced_movie_filter)) },
                navigationIcon = {
                ...
                ShowUpFrom(
                    ...
                    SmallFloatingActionButton(
                        ...
                        Icon(
                            ...
                            contentDescription = stringResource(Res.string.to_start_icon)
                        )
                    }
                }
            }
        ...
        LazyRow(horizontalArrangement = Arrangement.spacedBy(MaterialTheme.dimen.small)) {
            items(SortCriteria.entries) {
                ElevatedFilterChip(
                    ...
                    label = { Text(text = stringResource( it.labelResource)) },
                    shape = CircleShape,
                )
            }
        }
...
val SortCriteria.labelResource: StringResource
    get() = when (this) {
        SortCriteria.Popularity -> Res.string.popularity
        SortCriteria.VoteAverage -> Res.string.vote_average
        SortCriteria.VoteCount -> Res.string.vote_count
        SortCriteria.Revenue -> Res.string.revenue
    }
